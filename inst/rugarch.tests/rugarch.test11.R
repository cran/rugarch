...
rugarch.test11a = function(parallel = FALSE, parallel.control = list(pkg = c("multicore", "snowfall"), cores = 2))
{
	tic = Sys.time()
	...
	dist = ugarchdistribution(fit, n.sim = 1000, n.start = 1, 
			...
			fit.control = list(), solver = "solnp", solver.control = list(), parallel = parallel, 
